...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta name="description" content="Employee Management Information System for Polytechnic College of Botolan"/>
...
<!--        <script
 ...
 <script src="{{ asset('material') }}/js/jquerylocation.js"></script>
