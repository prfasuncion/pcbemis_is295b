              ...
              <div class="nav-tabs-navigation">
                <div class="nav-tabs-wrapper">
                  <ul class="nav nav-tabs" data-tabs="tabs">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="{{ route('utask.task_ongoing')}}">
                        <i class="material-icons">verified</i> IN-PROGRESS <span class="notification">{{'('.$ongoing.')'}}</span>
                        <div class="ripple-container"></div>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{route('utask.task_finished')}}" >
            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="messages">
                  <div class="row">
                  <div class="col-sm-6">
                    <h5><strong>Tasks In-Progress</strong></h5>
                  </div>
                  <div class="col-sm-6">
                      ...
                      <tr>
                       ...
                       <!--  <td>{{$y->accepted}}</td> -->
                        ...
                        <!--    <a rel="tooltip" class="btn btn-success " href="{{ route('utask.ongoing', [Crypt::encrypt($x->id)]) }}" data-original-title="" title="View Task">
                         ...
                         <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('utask.ongoing', [Crypt::encrypt($x->id)]) }}" data-original-title="" title="View Task">
