                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="td-action text-right">
                            ...
                            @if($result_exist==0)
                            <a rel="tooltip" class="btn btn-sm btn-success " href="{{route('usereval.evaluate_employee', [$id= Crypt::encrypt($evaluation->id), $emp_id=Crypt::encrypt($employee_id)])}}" data-original-title="" title="" >
                              
                              <i class="material-icons"></i>Evaluate
                              <div class="ripple-container"></div>
                            </a>
                            @else
                            <a rel="tooltip" class="btn btn-sm btn-primary " href="{{route('usereval.evaluation_result', [$id= Crypt::encrypt($evaluation->id), $emp_id=Crypt::encrypt($employee_id)])}}" data-original-title="" title="" >
