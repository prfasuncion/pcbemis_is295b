@extends('layouts.app', ['activePage' => 'usertask', 'titlePage' => __('My Tasks>In-Progress')])
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$the_task->created_at}}</td>
                      <td>{{$the_task->accepted}}</td>
                      <td>
                         @if(isset($the_task->finished))
                        {{'Task Finished on '.$the_task->finished}}
                        @endif
                      </td>
                    </tr>
                    @endforeach
