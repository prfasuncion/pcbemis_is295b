              ...
              <div class="nav-tabs-navigation">
                <div class="nav-tabs-wrapper">
                  <ul class="nav nav-tabs" data-tabs="tabs">
                    ...
                    @endforeach
                    <li class="nav-item">
                      <a class="nav-link active" href="{{ route('usertask.index') }}">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-right">
                         ...
                         <!-- <a rel="tooltip" class="btn btn-success btn-link" href="" data-original-title="" title="View Task">
