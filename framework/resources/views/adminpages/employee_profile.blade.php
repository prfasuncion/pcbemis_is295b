      ...
      <div class="col-md-12">
            ...
            <div class="card-header card-header-primary" style="vertical-align: middle; display: inline-block;">
              <h4 class="card-title ">
              	...
              	<div class="float-right">
              		<a class="btn btn-info btn-sm" target="_blank" href="{{route('employee.print_profile', [Crypt::encrypt($userprofile->id)])}}">Print</a>
              	</div>
              </h4>
         ...
         <div class="card">
            ...
            <!--   		<button class="btn btn-info btn-sm">Print</button> -->
         			...
         			<div class="modal fade add-sr" tabindex="-1" id="mymodal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add to Service Record</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                               <div class="modal-body">
                              <form  method="post" action="{{route('employee.add_service_record', [Crypt::encrypt($userprofile->id)])}}" id="add_sv">
                                 @csrf
                                 @method('post')
                                <div class="form-group">
                                  <label for="recipient-name" class="col-form-label">Position</label><br>
                                ...
                                <div class="col-sm-4">
                                <div class="form-group">
                                  <label for="message-text" class="col-form-label">Date:</label><br>
                                  <input type="date" class="form-control" name="from" id="from_new" >
                                </div>
                                </div>
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit" class="btn btn-primary btned" onclick="checkdate()">Save</button>
                              </form>
                            </div>
                          </div>
                        </div>
...
<!-- <script>
     document.getElementById('from_new').valueAsDate = new Date();
function handler(e) {
        // alert(e.target.value);
 
  var inputDate = new Date(document.getElementById("from_new").value);
  var date = new Date();
  if(inputDate < date){
