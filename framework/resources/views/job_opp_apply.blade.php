...
<div class="container" style="height: auto; width: 100%;">
  @if (session()->has('success'))
        ...
        <div class="card col-sm-12"  >
          ...
          <div class="card-body" >
            <div class="row">
               ...
               <div class="col-sm-12">
              <h3 class="text"><strong>{{$job_opp->job_title}}</strong></h3>
              </div>
              <div class="col-sm-12"> <h5 class="text">  {{'('}}&#8369;{{$job_opp->job_salary.')'}}</h5></div><br>
              <div class="col-sm-12">
              ...
              <h3 class="text">Apply Now!</h3>
               <form action="{{ route('jobs.apply', [Crypt::encrypt($job_opp->id)]) }}" method="POST" name="myform" id="apply_form" enctype="multipart/form-data">
                ...
                <h3 class="text">Application Intent</h3>
                <div class="row">
                  <div class="col-sm-12 ">
                ...
                <br>
                <h3 class="text">Attach a resume (accepts pdf file only) </h3>
                <div class="row">
                  <div class="col-sm-12">
    ...
    overflow-y: auto;">
                                  ...
                                  <h4 class="text">Application for {{$job_opp->job_title}}</h4>
                                  </div>
                                  <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                      <label for="num" class="col-form-label">Birthday</label><br>
                                      <input type="date" class="form-control" value="" id="apply_bday" name="apply_bday" readonly >
                                    </div>
                                    </div>
...
$("#image").change(function(e) {
  ...
  $("#apply").on('shown.bs.modal', function () {
           ...
           $('#apply_img').attr('src', $('#img').attr('src')); 
          $('#apply_email').val($('#email').val()) ;
         
          $('#apply_num').val($('#num').val());
          $('#apply_lname').val($('#lname').val()) ;
          $('#apply_fname').val($('#fname').val());
          $('#apply_mname').val($('#mname').val());
          $('#apply_name_ext').val($('#name_ext').val()); 

          $('#apply_province').val($( "#province option:selected" ).text());
       

        $('#apply_city').val($( "#city option:selected" ).text());
        

        $('#apply_brgy').val($( "#barangay option:selected" ).text());
       

        $('#apply_street').val($('#street').val());
        $('#ap_city').val($( "#city option:selected" ).text());
       $('#ap_brgy').val($( "#barangay option:selected" ).text());
       $('#ap_province').val($( "#province option:selected" ).text());
        $("#intent_val").html((tinymce.get("description").getContent({ format: "html" })));
      
         $('#apply_bday').val($('#bday').val());
