@extends('layouts.app', ['activePage' => 'evaluation', 'titlePage' => __('Evaluations')])
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="messages">
                	<div class="row">
                      ...
                      <a href="{{ route('user_evaluation.index')}}" class="btn btn-sm btn-warning">Back</a>

                      <a href="{{route('evaluation.print_evaluation_result', [$id = Crypt::encrypt($evaluation->id), $emp_id= Crypt::encrypt($employee->id)])}}" target="_blank" class="btn btn-sm btn-info"><i class="material-icons">print</i> Print</a>
                    </div>
              			<h5>
              					...
              					<tbody>
              						...
              						<?php $oi_result=0; $oi_count=0;  ?>
				                        @foreach ($eval_results as $eval_result)
              							...
              							<td>
              								<?php echo number_format((float)$oi_rating, 2, '.', '');  ?>
