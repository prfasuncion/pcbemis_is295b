              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="messages">
                	<div class="row">
                      ...
                      <a href="{{route('usereval.evaluation_print_myresult', [$id = Crypt::encrypt($evaluation->id), $emp_id= Crypt::encrypt($employee->id)])}}" target="_blank" class="btn btn-sm btn-info">PRINT</a>
                    </div>
              			<h5>
