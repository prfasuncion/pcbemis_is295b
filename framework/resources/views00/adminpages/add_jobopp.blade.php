    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="{{  route('job_opportunity.store')}}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')        
                  ...
                  <div class="col-sm-12 ">
                    ...
                    <input class="form-control" type="text"  name="jobtitle" id="desigtitle" required>
                  </div><br>
                  ...
                  <!-- <div class="col-sm-12 ">
                   ...
                   <div class="col-sm-12 ">
                    ...
                    <input class="form-control" type="text"  name="salary" id="desigtitle" >
                  </div><br>
