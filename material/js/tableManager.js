        ...
        if (options !== null) {
            ...
            **/
            ...
            if (
                ...
                var numrowsDiv =
                    ...
                    ': </label><select class="selectpicker" id="numrows"></select></div>';
            ...
            **/
            if (pagination === true || Table.hasClass("tablePagination")) {
                ...
                var pagesDiv =
                    '<div id="pagesControllers" class="pagesControllers pull-right"></div>';
            ...
            **/
            if (
                ...
                var filterbyDiv =
                    ...
                    ': </label><select class="selectpicker" id="filter_by" ></select></div> <input class="form-control" id="filter_input" type="text" placeholder="' +
        ...
        function appendPageControllers(nPages) {
            ...
            $("#pagesControllers").append(
                $("<button>", {
                    ...
                    type: "button",
                    text: "<<",
                    class: "btn btn-sm btn-light pagecontroller pagecontroller-f",
                })
            );
            // Previous
            $("#pagesControllers").append(
                $("<button>", {
                    ...
                    type: "button",
                    text: "<",
                    class: "btn btn-sm btn-light pagecontroller pagecontroller-p",
                })
            );
            // Numbers
            for (i = 1; i <= nPages; i++) {
                $("#pagesControllers").append(
                    $("<button>", {
                        ...
                        type: "button",
                        text: i,
                        class: "btn btn-sm btn-light pagecontroller pagecontroller-num",
                    })
                );
            }
            // Next
            $("#pagesControllers").append(
                $("<button>", {
                    ...
                    type: "button",
                    text: ">",
                    class: "btn btn-sm btn-light pagecontroller pagecontroller-n",
                })
            );
            // Last
            $("#pagesControllers").append(
                $("<button>", {
                    ...
                    type: "button",
                    text: ">>",
                    class: "btn btn-sm btn-light pagecontroller pagecontroller-l",
                })
            );
        }
