<?php
// Design by www.gowebs.in call - 8585814444
define("DB_HOST", "localhost");
define("DB_USERNAME", "root");
define("DB_PASSWORD","");
define("DB_NAME", "pcbemis");
...
function backup_database($con, $tables, $backup_file_name){
  ...
  foreach($tables as $table) {
     ...
     * Design by gowebs tm if want to face any problem and devlop your website visit www.gowebs.in
     */
    $insert_limit = 100;
    $insert_count = 0;
    $total_count  = 0;
  ...
  //Set the HTTP header of the page.
    ...
    $path='backup';//Enter your folder name
    $backup_file_name = $path. " backup- " . date( "d-m-Y--h-i-s").".sql";

$fp = fopen($path.'/' . $backup_file_name ,'w+');
